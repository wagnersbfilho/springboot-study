        ...
        new Thread() {
            ...
            public void run() {
                while(true)
                {
                    try {
                        Thread.sleep(5000);
                        List<Mensagem> list =  ServiceControl.getMessages();
                        String mensagem = "";
                        for(Mensagem m : list)
                        {
                            ...
                            if(m.getUser().equals(""))
                            {
                                mensagem = mensagem + "-> " + m.getMsg() + "\n";
                            }
                            //CONVERSA ENTRE OS USUARIOS
                            else
                            {
                               mensagem = mensagem + "-> " + m.getUser() + " diz: "  + m.getMsg() + "\n"; 
                            }
        ...
        new Thread() {
            ...
            public void run() {
                while(true)
                {
                    try {
                        Thread.sleep(5000);
                        List<Usuario> list =  ServiceControl.getUsers();
                        System.out.println("List usuario size:"+ list.size());
                        String usuarios = "";
                        for(Usuario u : list)
                        {
                            usuarios = usuarios + u.getNome() + "\n";
                        }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(scrollPaneEnviar, javax.swing.GroupLayout.PREFERRED_SIZE, 424, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(bntSend))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(2, 2, 2)
                        .addComponent(scrollPaneMessages, javax.swing.GroupLayout.PREFERRED_SIZE, 495, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(203, 203, 203)
                        .addComponent(lbMessages, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(scrollPaneUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(scrollPaneMessages, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(scrollPaneEnviar, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                            .addComponent(bntSend, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)))
